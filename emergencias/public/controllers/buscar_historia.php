				...
				<table class="table table-hover historia">
					<thead>
						...
						<td colspan="1" class="color2">
        					<a href="../views/home.php">
  								<img src="../../files/img/logoem2.jpg" style="width:60%; height: 40px">
    						</a>
						</td>
							<td colspan="9" class="ths">
								<label style="margin-top: 1%; margin-right: 30%">HISTORIA CLINICA DEL PACIENTE</label>
							</td>
						</tr>
					</thead>
