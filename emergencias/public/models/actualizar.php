...
?>        
          ...
          <thead>
            ...
            <td colspan="1" class="color2">
                  <a href="../views/home.php">
                  <img src="../../files/img/logoem2.jpg" style="width:80%; height: 40px">
                </a>
            </td>
              <td colspan="4" class="ths">
                <label style="margin-top: 1%; margin-right: 30%">ACTUALIZAR INFORMACION DEL USUARIO</label>
              </td>
            </tr>
          </thead>
