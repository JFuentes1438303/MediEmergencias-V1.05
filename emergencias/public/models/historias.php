<?php 
  ...
  if ($_SESSION["usuario"] != "1") {
	...
	class Historias{
		public function diligenciar($tdocumento, $documento, $edad, $nombres, $apellidos, $fnacimiento, $ciudad, $departamento, $direccion, $sexo, $ocupacion, $ecivil, $entidad, $regimen, $region, $escolaridad, $triage, $motivo, $enfermedad, $antecedentes, $toxico, $fisiologico, $examenes){
