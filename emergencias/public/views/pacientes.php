      ...
      <nav class="navbar navbar-expand-lg color1" style="border-bottom: 5px solid #818181;">
    	...
    	<div class="container div color2">
          ...
          <div class="col-sm-9 titulos">
		    ...
		    <form action="../controllers/pacientes.php" method="POST" onsubmit="return validacion();">
  				...
  				<div class="row espacio">
  					...
  					<div class="col-sm-6">
  						<input type="text" class="form-control inputs" id="dpaciente" placeholder="documento..." name="dpaciente"  autocomplete="off">
  					</div>
  				</div>
